...
function App() {
  ...
  return (
    <div class="App">
      ...
      <h1 class="GameHeader">Gaming Informat</h1>
      <div class="Content">
        <div class="GameList">
          <h2 class="GameListTitle"> Games soon to be released! </h2>
          {gamedata.filter(Searchfilter).map(rendergame)}
        </div>

        <div class="GameList">
          <h2 class="GameListSalesTitle"> Games on sale! </h2>
          {saledata.filter(Searchfilter).map(rendersales)}
        </div>

        <div class="GameList">
          <h2 class="GameListTitle"> Favorites! </h2>
